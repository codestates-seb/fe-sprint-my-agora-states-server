...
router.get('/', findAll); // GET http://localhost:5001/discussions/ 

// TODO: discussion 하나를 조회하는 라우터를 작성합니다.
router.get('/:id', findById); // GET http://localhost:5001/discussions/:id

// ADVANCED: discussion 하나를 생성하는 라우터를 작성합니다.
// router.create('/', createOne);

// ADVANCED: discussion 하나를 수정하는 라우터를 작성합니다.
// router.update('/:id', updateById);
